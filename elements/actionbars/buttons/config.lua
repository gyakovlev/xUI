  ...
  cfg.textures = {
    normal            = "Interface\\AddOns\\xUI\\media\\gloss",
    flash             = "Interface\\AddOns\\xUI\\media\\flash",
    hover             = "Interface\\AddOns\\xUI\\media\\hover",
    pushed            = "Interface\\AddOns\\xUI\\media\\pushed",
    checked           = "Interface\\AddOns\\xUI\\media\\checked",
    equipped          = "Interface\\AddOns\\xUI\\media\\gloss_grey",
    buttonback        = "Interface\\AddOns\\xUI\\media\\button_background",
    buttonbackflat    = "Interface\\AddOns\\xUI\\media\\button_background_flat",
    outer_shadow      = "Interface\\AddOns\\xUI\\media\\outer_shadow",
  }
