...
local zonetext = minimapinfo:CreateFontString("ncUIZoneText", "OVERLAY", "xUIfont")
...
local text=ping:CreateFontString("Ping","ARTWORK","xUIfonts")
...
local coordtextleft = minimapinfo:CreateFontString("ncUICoordTextLeft", "OVERLAY", "xUIfont")
coordtextleft:Point("BOTTOMLEFT", Minimap, 10, 10)
coordtextleft:SetJustifyH("LEFT")

local coordtextright = minimapinfo:CreateFontString("ncUICoordTextRight", "OVERLAY", "xUIfont")
